...
object FirebaseCrud {
    private const val DB_URL = "https://bane-myhome-default-rtdb.asia-southeast1.firebasedatabase.app/"
    private val database = Firebase.database(DB_URL)
    ...
    //    Get Device Status
    suspend fun getDeviceStatus() : DataSnapshot {
