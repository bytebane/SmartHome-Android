...
import 'package:smarthome/helpers/fan_db_help.dart';
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Slider(
                                  ...
                                  max: 1,
                                  // max: 5,
                                  label: _myFans.fan1Speed.value.toString(),
                                  value: _myFans.fan1Speed.value.toDouble(),
                                  thumbColor: _tc.isDarkTheme.value
                                      ? myPrimaryColor
                                      : colorBlack,
                                  activeColor: _tc.isDarkTheme.value
                                      ? myPrimaryDarkColor
                                      : colorBlack,
                                  ...
                                  // divisions: 5,
                                  onChanged: (value) {
                                    _myFans.fan1Speed.value = value.toInt();
                                    // Send To Firebase
                                  },
                                  onChangeEnd: (value) {
                                    _myFans.setFanStats(
